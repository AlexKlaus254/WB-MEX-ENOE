...
<_Program name_>				[MEX_2025_ENOE_V01_M_V06_A_GLD_ALL.do] </_Program name_>
<_Application_>					[STATA] <_Application_>
<_Author(s)_>					[The World Bank Jobs Group] </_Author(s)_>
<_Date created_>				2025-12-11 </_Date created_>
...
<_Data collection to_>			[05/2025] </_Data collection to_>
...
* Date: [2025-02-08] - [Correct empstat]
* Date: [2025-03-29] - [Correct subnatid1, educy]
* Date: [2025-11-11] - [Correct quarter, level1, d_mes, includevars, *set mem, includevars]
...
if c(os)=="Windows" local server "C:/Users/Alex/Downloads/GLD/Data"
...
local source_data "C:/Users/Alex/Downloads/enoe_2025_trim1_dta"
...
*Derivado de los cambios presentados en la Nota Técnica del primer trimestre de 2025, el INEGI
...
else if `x'==125 | `x'==223 | `x'==323 | `x'==423{; 
...
*ISIC
	***first job
		...
		merge m:1 scian using "`path_in_stata'/SCIAN_07_3D_ISIC_4", keep(master match) nogen
...
*<_povertyincome_>
	...
	scalar  uT124 = 2284.55 ;
	scalar  rT124 = 1747.58 ;
	scalar  uT224 = 2325.24 ;
	scalar  rT224 = 1779.53 ;
	scalar  uT324 = 2371.74 ;
	scalar  rT324 = 1816.12 ;
	scalar  uT424 = 2420.17 ;
	scalar  rT424 = 1853.45 ;

	scalar  uT125 = 2468.57 ;
	scalar  rT125 = 1890.52 ;	
